 ...
 * @subpackage Novaramedia_Shareables/public
 */
 ...
 */
class Novaramedia_Shareables_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $novaramedia_shareables       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->novaramedia_shareables, plugin_dir_url( __FILE__ ) . 'css/novaramedia-shareables-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->novaramedia_shareables, plugin_dir_url( __FILE__ ) . 'js/novaramedia-shareables-public.js', array( 'jquery' ), $this->version, false );
