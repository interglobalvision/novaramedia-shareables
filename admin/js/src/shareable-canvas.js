...
class ShareableCanvas {
  ...
  addTopText(sourceText) {
    let topLeftText = new createjs.Text(sourceText, 'bold ' + '40px helvetica, sans-serif', '#ffffff');
  ...
  addFooterText(sourceText) {
    const fontSize = 40;
    let footertext = new createjs.Text(sourceText, 'bold ' + fontSize + 'px helvetica, sans-serif', '#ffffff');
